...
const Santa = () => {
  ...
  return (
    <div className="min-h-screen relative overflow-hidden bg-gradient-to-br from-black via-blue-900 via-blue-500 to-black">
      ...
      <div
        className="absolute bottom-10 left-1/4 z-10 opacity-80 animate-bounce"
        style={{ animationDuration: "3s" }}
      >
        <div className="text-5xl">🎁</div>
      </div>
      <div
        className="absolute bottom-24 right-1/4 z-10 opacity-80 animate-bounce"
        style={{ animationDuration: "2.5s", animationDelay: "0.5s" }}
      >
        <div className="text-6xl">🎁</div>
      </div>
      <div
        className="absolute top-1/3 left-1/4 z-10 opacity-70 animate-bounce"
        style={{ animationDuration: "3.5s", animationDelay: "1s" }}
      >
        <div className="text-4xl">🎁</div>
      </div>
      <div
        className="absolute top-1/4 right-1/3 z-10 opacity-70 animate-bounce"
      ...
      <div
        className="absolute top-20 right-1/4 z-10 opacity-80 animate-pulse"
        style={{ animationDelay: "0.5s" }}
      >
        <div className="text-5xl">✨</div>
      </div>
      <div
        className="absolute top-1/3 left-1/3 z-10 opacity-70 animate-pulse"
        style={{ animationDelay: "1s" }}
      >
        <div className="text-4xl">⭐</div>
      </div>
      <div
        className="absolute top-40 right-1/3 z-10 opacity-70 animate-pulse"
        style={{ animationDelay: "1.5s" }}
      >
        <div className="text-5xl">✨</div>
      </div>
      <div
        className="absolute bottom-1/3 left-1/4 z-10 opacity-60 animate-pulse"
        style={{ animationDelay: "2s" }}
      >
        <div className="text-4xl">⭐</div>
      </div>
      <div
        className="absolute bottom-1/4 right-1/4 z-10 opacity-60 animate-pulse"
      ...
      <div className="absolute bottom-0 left-32 z-5 opacity-60">
        <img
          src={xmastar}
          alt="stars"
          className="w-35 h-40 object-cover ml-20"
        />
        <img
          src={tree}
          alt="xmass_tree"
      ...
      <div
        className="absolute bottom-1/3 left-16 z-10 opacity-70 animate-pulse"
        style={{ animationDelay: "1s" }}
      >
        <div className="text-4xl">🔔</div>
      </div>
      ...
      <div className="relative z-20 flex flex-col items-center justify-center min-h-screen p-4 sm:p-8">
        ...
        {stage === "welcome" && (
          <div className="text-center animate-fade-in">
            <div className="bg-white/10 backdrop-blur-lg rounded-3xl p-6 sm:p-12 shadow-2xl border-4 border-yellow-300/50 max-w-md w-full mx-auto">
              <img
                src={santa}
                className="w-40 text-yellow-300 mx-auto mb-6 "
                style={{ animationDuration: "3s" }}
              />
              ...
              <h2 className="text-4xl sm:text-5xl mb-6 text-center drop-shadow-lg animate-fade-in">
                ...
                <span className="inline-block text-[35px] animate-bounce ml-2">
                  🎁
                </span>
              </h2>
        ...
        {stage === "gift-selection" && (
          <div className="text-center max-w-6xl animate-fade-in px-4">
            ...
            <h2 className="text-2xl sm:text-4xl font-bold mb-3 sm:mb-4 text-center drop-shadow-lg animate-fade-in">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-3 sm:gap-6">
              {gifts.map((gift, index) => (
                ...
                >
                  <div
                    className={`text-5xl sm:text-7xl mb-2 sm:mb-4 group-hover:scale-125 transition transform`}
                  >
                    🎁
                  </div>
                  <div
                    className={`w-10 h-10 sm:w-12 sm:h-12 rounded-full bg-gradient-to-r ${gift.color} mx-auto flex items-center justify-center group-hover:animate-pulse`}
                  >
        ...
        {stage === "gift-reveal" && selectedGift && (
          <div className="text-center max-w-3xl animate-fade-in px-4">
            ...
            <div
              className={`bg-gradient-to-br ${selectedGift.color} p-1 rounded-3xl mb-6 sm:mb-8 shadow-2xl`}
            >
              <div className="bg-white/20 backdrop-blur-lg rounded-3xl p-6 sm:p-12">
                <div className="mb-4 sm:mb-6">
                  {React.createElement(selectedGift.icon, {
                    className:
                      "w-20 h-20 sm:w-32 sm:h-32 text-white mx-auto animate-bounce",
                    strokeWidth: 1.5,
                  })}
                </div>
